"""Test engine.ui_element.focus_window — mock find_all_windows/wrapper ทั้งหมด
(pywinauto Desktop จริงต้องพึ่ง state ของเครื่อง ไม่ hermetic)
"""
import engine.ui_element as ui_element
from engine.ui_element import ElementNotFoundError, focus_window
